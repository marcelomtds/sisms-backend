...
public class PacoteController {
    ...
    public ResponseEntity<Response<PacoteDTO>> closePackage(@PathVariable final Long id) {
        return ResponseEntity.ok().body(new Response(service.closePackage(id), MessageEnum.MSG0028.toString()));
    }
    ...
    public ResponseEntity<Response<PacoteDTO>> findLast(@PathVariable final Long categoriaAtendimentoId, @PathVariable final Long pacienteId) {
        return ResponseEntity.ok().body(new Response(service.findLastOpen(categoriaAtendimentoId, pacienteId), MessageEnum.MSG0028.toString()));
    }
